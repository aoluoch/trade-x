                ...
                <Card>
                  <CardContent className="p-6 flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">123 Mombasa Road</p>
                ...
                <Card>
                  <CardContent className="p-6 flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">info@kenyatradex.com</p>
                      <p className="text-muted-foreground">support@kenyatradex.com</p>
                    </div>
                  </CardContent>
                </Card>
              </div>
              ...
              <Card className="shadow-md">
                ...
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Button type="submit" className="w-full bg-[#032D60] hover:bg-[#022348] flex items-center gap-2 py-6">
      ...
      <section className="py-16 bg-[#032D60] text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto text-gray-300">
            ...
            help you optimize your logistics and supply chain.
          </p>
